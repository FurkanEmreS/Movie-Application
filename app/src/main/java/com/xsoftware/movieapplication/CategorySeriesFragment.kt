...
class CategorySeriesFragment : Fragment(), CategoryAdapter.OnItemClickListener {
    ...
    private fun fetchGenres() {
        ...
        apiService.getTvGenres().enqueue(object : Callback<GenreResponse> {
            override fun onResponse(call: Call<GenreResponse>, response: Response<GenreResponse>) {
                ...
                binding.categoryRecyclerView.adapter = CategoryAdapter(genres, this@CategorySeriesFragment)
            }
